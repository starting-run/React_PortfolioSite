                                        ...
                                        <div class="row row-cols-lg-2 row-cols-xxl-3 p-2 card-hover-up rounded-4">
                                            ...
                                            <div class="col-auto mb-2 font-11 p-4">
                                                ...
                                                <div class="fw-light2 fs-6">
                                                    <a class="btn btn-sm btn-dark-square px-4 py-2 me-sm-3 fs-6 fw-bold rounded-4" href="https://velog.io/@usfree/42%EC%84%9C%EC%9A%B8-%EB%9D%BC%ED%94%BC%EC%8B%A0-10%EA%B8%B0-1%EC%B0%A8-%ED%9B%84%EA%B8%B0" target='_blank'>돌아보기　<FontAwesomeIcon icon={faArrowUp} className='rot-45deg'/></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-cols-lg-2 row-cols-xxl-3 p-2 card-hover-up rounded-4">
                                            <div class="col-auto mb-2 font-11 p-4">
                                                ...
                                                <div class="fw-light2 fs-6 mb-2">
                                                    <a class="btn btn-sm btn-dark-square px-4 py-2 me-sm-3 fs-6 fw-bold rounded-4" href="https://www.acmicpc.net/user/tlrmsjtm77" target='_blank'>바로가기　<FontAwesomeIcon icon={faArrowUp} className='rot-45deg'/></a>
                                                </div>
                                            </div>
                                            <div class="col-auto mb-2 font-11 p-4">
                                                ...
                                                <div class="fw-light2 fs-7 mb-3 highlight">tlrmsjtm77</div>
                                                <div class="fw-light2 fs-6 mb-2">
                                                    <a class="btn btn-sm btn-dark-square px-4 py-2 me-sm-3 fs-6 fw-bold rounded-4" href="https://codeforces.com/profile/tlrmsjtm77" target='_blank'>바로가기　<FontAwesomeIcon icon={faArrowUp} className='rot-45deg'/></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="h-100 overflow-hidden py-2 px-4">
                                            ...
                                            <div class="row row-cols-lg-3 p-2 font-11 card-hover-up rounded-4">
                                                <div class="col-auto mb-2 p-4">
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">C</div><span> </span>
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">C++</div>
                                                ...
                                                <div class="col-auto mb-2 p-4">
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">UnrealEngine</div>
                                                    <div class="fw-light2 fs-6 mb-2 text-black">C++을 사용하여 언리얼엔진을 활용할 수 있고, 목표한 컨텐츠를 제작하기 위해 학습중입니다.</div>
                                                </div>
                                                <div class="col-auto mb-2 p-4">
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">Unity</div>
                                                ...
                                                <div class="col-auto mb-2 p-4">
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">HTML5</div><span> </span>
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">CSS3</div><span> </span>
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">JavaScript</div>
                                                    <div class="fw-light2 fs-6 mb-2 text-black">HTML, CSS와 JavaScript를 통해 주어진 기능을 수행하는 웹페이지를 구현할 수 있습니다.</div>
                                                </div>
                                                <div class="col-auto mb-2 p-4">
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">React</div>
                                                    <div class="fw-light2 fs-6 mb-2 text-black">DOM의 구조를 알고 컴포넌트를 활용하여 SPA방식의 프론트 웹페이지를 제작할 수 있습니다.</div>
                                                </div>
                                                <div class="col-auto mb-2 p-4">
                                                    <div class="fs-6 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2 rounded-4">Processing</div>
