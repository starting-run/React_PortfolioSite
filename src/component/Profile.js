                                    ...
                                    <div class="h-100 overflow-hidden py-2 px-4">
                                        ...
                                        <div class="row row-cols-lg-2 row-cols-xxl-3 p-2 card-hover-up  rounded-4">
                                            <div class="col-auto mb-2 font-11 p-4">
                                                ...
                                                <div class="fw-light2 fs-7 mb-2 highlight">tlrmsjtm77</div>
                                ...
                                <div class="col">
                                    <div class="h-100 overflow-hidden py-2 px-4">
                                        ...
                                        <div class="row row-cols-lg-3 p-2 font-11 card-hover-up  rounded-4">
                                            <div class="col-auto mb-2 p-4">
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">C</div><span> </span>
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">C++</div>
                                            ...
                                            <div class="col-auto mb-2 p-4">
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">UnrealEngine</div>
                                                <div class="fw-light2 fs-6 mb-2 text-black">C++을 사용하여 언리얼엔진을 활용할 수 있고, 목표한 컨텐츠를 제작하기 위해 학습중입니다.</div>
                                            </div>
                                            <div class="col-auto mb-2 p-4">
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">Unity</div>
                                                <div class="fw-light2 fs-6 mb-2 text-black">C#을 사용하여 Unity를 다룰 수 있습니다.</div>
                                            </div>
                                            <div class="col-auto mb-2 p-4">
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">HTML5</div><span> </span>
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">CSS3</div><span> </span>
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">JavaScript</div>
                                                <div class="fw-light2 fs-6 mb-2 text-black">HTML, CSS와 JavaScript를 통해 주어진 기능을 수행하는 웹페이지를 구현할 수 있습니다.</div>
                                            </div>
                                            <div class="col-auto mb-2 p-4">
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">React</div>
                                                <div class="fw-light2 fs-6 mb-2 text-black">DOM의 구조를 알고 컴포넌트를 활용하여 SPA방식의 프론트 웹페이지를 제작할 수 있습니다.</div>
                                            </div>
                                            <div class="col-auto mb-2 p-4">
                                                <div class="fs-5 fw-light2 fw-opacity btn btn-primary-round-outline py-0 mb-2">Processing</div>
