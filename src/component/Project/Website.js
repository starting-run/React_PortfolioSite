            ...
            <div id="projectmain">
                <div className="bg-white-gray">
                    <div className="container-xxl px-4 pt-6" id="seemore">
                        ...
                        <a href="https://github.com/usfree/usfree.github.io" target='_blank' className="btn btn-dark-square px-4 py-2-5 me-3 fs-6 fw-bold mb-5 rounded-4"><FontAwesomeIcon icon={faGithub} /> 리포지토리</a>
                        <a href="https://usfree.site" target='_blank' className="btn btn-dark-square px-4 py-2-5 fs-6 fw-bold mb-5 rounded-4">사이트 바로가기　<FontAwesomeIcon icon={faArrowUp} className='rot-45deg fs-7'/></a>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="p-2 proj_text w-100 text-black fw-light">
                                                <div className="mb-3 w-100 card card-cover-nonhover p-3 border-0 font-11 rounded-4">
                                                    ...
                                                    <div className="fw-bold fs-6 mb-2 highlight px-2">주요 기능　<span className="fw-light fs-6 mb-2 text-black">React를 사용하여 SPA형식으로 제작된 포트폴리오 게시용 사이트입니다.</span></div>
                                                ...
                                                <img className="mb-2 shadow-lg  " src={img1} style={{width: '800px'}}/>
                                                ...
                                                <img className="mb-2 shadow-lg  " src={img2} style={{width: '800px'}}/>
                                                <p className="mb-5 font-11">
                                                ...
                                                <img className="mb-2 shadow-lg  " src={img3} style={{width: '800px'}}/>
                                                <p className="mb-5 font-11">
