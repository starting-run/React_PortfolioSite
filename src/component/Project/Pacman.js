...
import video from '../../images/projects/Pacman/Processing_Pacman.mp4'
import pdf from '../../images/projects/Pacman/Processing_Pacman.pdf';
...
class Pacman extends Component {
    render() {
      ...
      >
            <Helmet><title>Pacman | STARTING</title></Helmet>
            <div id="projectmain">
                                            ...
                                            <div className="proj_text w-100 text-black fw-light">
                                                <div className="row row-cols-1 row-cols-lg-2 g-4">
                                                    ...
                                                    <div className="col-lg-8 project-view-padding">
                                                        ...
                                                        <div className="card card-border-0 p-0 rounded-4 mb-4" style={{width: '400px', height: '500px'}}>
                                                            <video className="card-image-sec1" src={video} controls controlsList="nodownload" style={{width: '400px', height: '500px'}}/>
                                                        </div>
