            ...
            <div id="projectmain">
                <div className="bg-white-gray">
                    <div className="container-xxl px-4 pt-6" id="seemore">
                        <div className="mb-2 fs-1 font-11 fw-bold2 font-letter-space-sm text-black text-uppercase">팩맨 게임</div>
                                    ...
                                    <div className="card-body p-0">
                                        <div className="d-flex align-items-center">
                                            <div className="p-2 proj_text w-100 text-black fw-light">
                                                ...
                                                <div className="code mb-2 font-11 rounded-4">{code1}</div>
                                                ...
                                                <div className="code mb-2 font-11 rounded-4"> {code2} </div>
