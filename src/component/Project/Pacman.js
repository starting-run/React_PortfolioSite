        ...
        <div>
            ...
            <div id="projectmain">
                ...
                <div class="container-full px-4 pt-6">
                    <span class="font-10 text-black fw-normal fs-7"><Link exact to="/">Home</Link> <FontAwesomeIcon icon={faChevronRight}/> <Link exact to="/project">Project</Link> <FontAwesomeIcon icon={faChevronRight}/> <NavLink exact to="/project/pacman">Pacman</NavLink></span>
                </div>
