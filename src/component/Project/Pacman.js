        ...
        <div>
            ...
            <div class="s-intro-prj">
                        ...
                        <div class="justify-content-center font-3">
                            <div class="text-black fs-0-7 lh-sm font-10 mb-5">
                                <div class="font-letter-space fw-bold3">
                                    <span className="font-11">팩맨 게임</span>
                                </div>
                            </div>
                            <div class="justify-content-center">
                                <div class="h-100 font-2 pt-2 text-black fs-6 font-letter-space text-uppercase">
                                    ...
                                    <a href="https://github.com/usfree/Processing_Pacman" target='_blank' class="btn btn-dark-round btn-lg px-5 py-2 fs-7 fw-bolder mt-3"><FontAwesomeIcon icon={faGithub} /> Repository</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white-gray">
                    ...
                    <div class="font-11 text-black fw-normal fs-7"><Link exact to="/">Home</Link> <FontAwesomeIcon icon={faChevronRight}/> <Link exact to="/project">Project</Link> <FontAwesomeIcon icon={faChevronRight}/> <NavLink exact to="/project/pacman">Detail</NavLink></div>
                        <span class="fs-1 fw-bold2 font-11 text-black font-letter-space-sm">PACMAN GAME</span>
                        <div class="mb-5">
                            <Link to='/project' className="btn btn-outline-dark-round btn-lg px-4 py-2 me-3 fs-7 fw-bolder mt-3"><FontAwesomeIcon icon={faChevronLeft} />　Back</Link>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="p-2 proj_text w-100 text-black fw-light">
                                                ...
                                                <div class="mb-4 px-2 font-11">인터랙티브 프로그래밍에 흔히 사용되는 Processing을 통해 제작된 게임입니다. 완성도 있는 구현을 위해 기존의 팩맨 게임 원작과는 게임 진행 방식에 약간의 수정을 가미하였습니다.</div>
                                                ...
                                                <span class="font-11">브라우저에서 PDF viewer를 지원하지 않을 경우 <a href="http://usfree.site/static/media/Processing_Pacman.32a699ec1c28427c6233.pdf"><div class="btn btn-primary-round-outline px-4 fs-7"><FontAwesomeIcon icon={faFileArrowDown} /> PDF</div></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
