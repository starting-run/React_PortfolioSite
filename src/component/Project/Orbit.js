                                            ...
                                            <div className="proj_text w-100 text-black fw-light">
                                                <div className="row row-cols-1 row-cols-lg-2 g-4">
                                                    <div className="col-lg-4">
                                                        ...
                                                        <div className="mb-2 fs-2 fw-bold2 font-11 project-title text-black">Orbit</div><span class="fs-7 font-11">　|　오르빗　|　게임</span>
                                                            <div className='mb-5'>
                                                                ...
                                                                <a href="https://orbit.starting.run" target='_blank' className="btn btn-dark-square px-3 py-2 fs-7 fw-bold rounded-3 me-3">홈페이지 <FontAwesomeIcon icon={faArrowUp} className='rot-45deg fs-7'/></a>
                                                            ...
                                                            <div className="mb-3 w-100 card card-cover-nonhover p-3 border-0 font-11 rounded-4">
                                                                <div className="fw-bold fs-6-5 mb-2 highlight px-2">제작 기간　<span className="fw-light fs-6-5 mb-2 text-black">2024. 03. - 2024. 11.</span></div>
                                                                ...
                                                                <div className="fw-bold fs-6-5 mb-2 highlight px-2">주요 기능　<span className="fw-light fs-6-5 mb-2 text-black">AI 몬스터를 처치하여 구역을 해방하는 목표를 달성하는 싱글플레이 / 플레이어들끼리의 전투를 지원하는 멀티플레이로 구성된 FPS게임</span></div>
                                                            ...
                                                            <div className="mb-4 px-2 font-11 fs-6-5">졸업 작품을 제작하기 위한 캡스톤디자인을 통해 제작된 게임 프로젝트입니다. 최신 Unity6의 엔진을 사용하고 있으며, 완성도와 기술적인 부분을 중점으로 개발된 게임입니다.</div>
