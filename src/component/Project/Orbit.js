            ...
            <div id="projectmain">
                <div class="bg-white-gray">
                    <div class="container-xxl px-4 pt-6" id="seemore">
                        ...
                        <a href="https://github.com/usfree/Unity_Orbit" target='_blank' class="btn btn-dark-square px-4 py-2-5 fs-6 fw-bold mb-5 rounded-4"><FontAwesomeIcon icon={faGithub} /> 리포지토리</a> {/* me-3*/}
                                        ...
                                        <div class="card-body p-0">
                                            <div class="d-flex align-items-center">
                                                <div class="proj_text w-100 text-black fw-light">
                                                    ...
                                                    <p class="mb-5 font-11">인간은 AI에게 지배당해 AI가 설계한 궤도를 돌 수 밖에 없음을 의미합니다.</p>
