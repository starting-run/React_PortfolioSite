            ...
            <div id="projectmain">
                <div class="bg-white">
                    <div class="container px-4">
                        <div class="pt-7 px-4">
                            <span class="display-4 fw-bolder font-5 text-black">IRONMAN 3D MODEL</span>
                            <div class="mb-5">
                                ...
                                <a href="https://github.com/usfree/OpenGL_Ironman" target='_blank' class="btn btn-dark-round btn-lg px-5 py-2 me-sm-3 fs-7 fw-bolder mt-3"><FontAwesomeIcon icon={faGithub} /> Repository</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="p-3 proj_text w-100 text-black fw-light">
                                                ...
                                                <span>브라우저에서 PDF viewer를 지원하지 않을 경우 <a href="https://usfree.site/static/media/OpenGL_Ironman.54c28fdf5dac7d4a96f2.pdf"><div class="btn btn-primary"><FontAwesomeIcon icon={faFileArrowDown} /> PDF</div></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
