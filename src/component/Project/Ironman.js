            ...
            <div id="projectmain">
                <div className="bg-white-gray">
                    <div className="container-xxl px-4 pt-6" id="seemore">
                        <div className="mb-2 fs-1 font-11 fw-bold2 font-letter-space-sm text-black text-uppercase">아이언맨 모델</div>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="p-2 proj_text w-100 text-black fw-light">
                                                <div className="mb-3 w-100 card card-cover-nonhover p-3 border-0 font-11 rounded-4">
                                                    ...
                                                    <div className="fw-bold fs-6 mb-2 highlight px-2">주요 기능　<span className="fw-light fs-6 mb-2 text-black">OpenGL로 제작된 3D 입체 아이언맨 모형. OpenGL이 지원하는 주요 기능들을 사용할 수 있습니다.</span></div>
                                                ...
                                                <span className="font-11">브라우저에서 PDF viewer를 지원하지 않을 경우 <a href="https://usfree.site/static/media/OpenGL_Ironman.54c28fdf5dac7d4a96f2.pdf"><div className="btn btn-primary-round-outline px-4 fs-7 rounded-4"><FontAwesomeIcon icon={faFileArrowDown} /> PDF</div></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
