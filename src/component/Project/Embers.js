...
function Embers() {
    const updatedate = "2099. 99. 99." //최종 업데이트 일자
                                                    ...
                                                    <div className="col-lg-4">
                                                        ...
                                                        <div className="mb-2 fs-2 fw-bold2 font-11 project-title text-black">잉걸불</div><span class="fs-7 font-11">　|　embers　|　게임</span>
                                                            ...
                                                            <div className="mb-3 w-100 card card-cover-nonhover p-3 border-0 font-11 rounded-4">
                                                                ...
                                                                <div className="fw-bold fs-6-5 mb-2 highlight px-2">주요 기능　<span className="fw-light fs-6-5 mb-2 text-black">A </span></div>
                                                            ...
                                                            <div className="mb-4 px-2 font-11 fs-6-5">gg.</div>
