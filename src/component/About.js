                                        ...
                                        <div className="h-100 overflow-hidden py-2">
                                            ...
                                            <div className="row row-cols-lg-2 p-2 font-11 rounded-4 mx-2">
                                                <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> C / C# / C++</div>
                                                ...
                                                <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> Unity</div>
                                                ...
                                                {/* <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> Unreal Engine5</div>
                                                    <div className="fw-light2 fs-6 mb-2 text-black">C++을 사용하여 언리얼엔진을 활용할 수 있고, 언리얼엔진을 통해 고품질의 게임을 만들기 위해 학습 중입니다.</div>
                                                </div> */}
                                                <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> DataBase</div>
                                                ...
                                                <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> HTML5 / CSS / JavaScript</div>
                                                    <div className="fw-light2 fs-6 mb-2 text-black">HTML, CSS와 JavaScript를 통해 주어진 기능을 수행하는 웹페이지를 구현할 수 있습니다.</div>
                                                </div>
                                                <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> React</div>
                                                    <div className="fw-light2 fs-6 mb-2 text-black">DOM의 구조를 알고 컴포넌트를 활용하여 SPA방식의 프론트 웹페이지를 제작할 수 있습니다.</div>
                                                </div>
                                                <div className="col-auto mb-2 p-4 py-2">
                                                    <div className="fs-5 fw-bold fw-opacity"><span className='bg-black p-1 highlight rounded-3'><FontAwesomeIcon icon={faAngleRight}/>_</span> Processing</div>
